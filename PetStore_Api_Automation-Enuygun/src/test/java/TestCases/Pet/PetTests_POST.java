...
public class PetTests_POST extends TestBase implements PetConstants {
    ...
    public void T01_createPet_200() throws IOException {
        ...
        URL file = Resources.getResource("pet.json"); //direkt json içerisindeki bir yeri güncelleyemediğimiz için
        String myJson = Resources.toString(file, Charset.defaultCharset()); //onu bir String variable'a atadık
        JSONObject petObject = new JSONObject(myJson); //içerde güncelleme yapabilmemizi sağlayan JSONObject constructor'ına json dosyamızı atadık
        ...
        given().given()
                ...
                .then()
                .statusCode(200) //Validating (StatusCode=200 and status=available)
    ...
    public void T02_createPet_500() throws IOException {
        ...
        given().given()
                ...
                .post(Var.apiUrl + POST_ENDPOINT)
                .then()
                .statusCode(500) //Validating (StatusCode=500 and status=something bad happened)
    ...
    public void T03_createPet_405() throws IOException {
        ...
        given().given() //belirli şartlar burada verilir
                .contentType("application/json")
                .body("")
                .when()
                .post(Var.apiUrl + POST_ENDPOINT)
                .then()
                .statusCode(405) //Validating (StatusCode=405 and status=no data)
