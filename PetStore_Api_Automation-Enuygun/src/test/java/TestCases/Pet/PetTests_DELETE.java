...
public class PetTests_DELETE extends TestBase implements PetConstants {
    ...
    public void T01_deletePet_200() throws IOException {
            ...
            logger.info("PUT Process with PetID"); //Burada ekstra olarak PUT ile modify ettikden sonra silme işlemine geçiyor
            petTests_put.T04_updatePet_200(petID,"sold");  //Direkt olarak sildirtmek istersek bu alan silinebilir
